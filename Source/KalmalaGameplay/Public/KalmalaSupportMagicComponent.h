...
public:
    ...
    // Bear's Vigor remains a finite self-support window for a committed exchange.
    static constexpr float BearsVigorDurationSeconds = 10.0f;
private:
    ...
    static constexpr float BearsVigorDuration = BearsVigorDurationSeconds;
