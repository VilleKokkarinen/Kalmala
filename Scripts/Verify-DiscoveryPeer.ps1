...
try {
    ...
    Write-Output 'PASS: same-seed descriptor reproduction and different-seed variation held; distant and duplicate discovery claims were rejected, while the remote peer retained no owner-only progress feedback.'
}
