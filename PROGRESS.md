...
Changed: `Source/KalmalaUI/Private/KalmalaMinimapRaster.cpp`; `Source/KalmalaUI/Public/KalmalaMinimapRaster.h`; `Source/KalmalaUI/Private/KalmalaWorldMapSubsystem.cpp`; `Source/KalmalaUI/Private/KalmalaWorldMapWidget.cpp`; `Source/KalmalaUI/Public/KalmalaWorldMapWidget.h`; `Source/KalmalaUI/Private/Tests/KalmalaWorldMapWidgetTest.cpp`; `Source/KalmalaUI/Private/Tests/KalmalaWorldMapPerformanceTest.cpp`; `Scripts/Verify-WorldMap.ps1`; `docs/02-technical-architecture.md`; `docs/07-development-setup.md`; `BACKLOG.md`; `PROGRESS.md`. Working tree was clean at start; concurrent construction edits that appeared during final verification are preserved outside this map commit.

Verification: Forced `KalmalaEditor Win64 Development -WaitMutex -NoHotReload -Force -MaxParallelActions=4` passed with UnrealBuildTool cache access. All five focused map/minimap tests passed: WorldMap.LocalPresentation, WorldMap.PerformanceBudget, Minimap.LocalPresentation, Minimap.AsyncRefresh, and Minimap.GenerationPerformance (`C:/Users/Ville/AppData/Local/Temp/KalmalaContinuousMap-d28c5624594d460fa4404bdfd0762cbf/automation.log`). Tile worker 29.486 ms; full minimap with four tile workers 53.479 ms; retained tile payload cap 278,784 bytes. Rendered `Verify-WorldMap.ps1 -BasePort 17954` passed at 1024x768, 1280x720, and 2560x1080 with both peers' closed-map coverage/zero tiles, input, server identity, and full viewport paint evidence (`C:/Users/Ville/AppData/Local/Temp/KalmalaWorldMap-1749c1610ded4971b8739312c99a1cd6`). `Verify-Minimap.ps1 -Rendered -GeneratorRevision 4 -Port 17958` passed both peers' HUD paint, zoom/modal restoration, and matching regional identity (`C:/Users/Ville/AppData/Local/Temp/KalmalaMinimap-9cdd040f27a241b288da89e001f66c99`). Screenshots inspected. The initial restricted render failed because Unreal could not write shader transfer files; the rerun with shader-working-directory access passed. `git diff --check` passed.

Multiplayer impact: Local presentation and personal exploration only. Sampling still uses the replicated immutable seed/revision and owning pawn transform. No new RPC, gameplay mutation, actor query, world-generation change, save-schema change, or shared exploration was added. Existing coverage slot identity and bounds remain intact.

Known limits: Unvisited terrain remains fogged; a fresh stationary player initially sees one reveal circle, which expands into connected remembered coverage through travel. Previously unrecorded travel cannot be reconstructed. The existing 8,192-cell coverage bound, map zoom range, terrain density, and original palette remain unchanged. Restart the editor to load rebuilt native modules; packaged builds were not produced.

Next task: Resume the earliest unchecked M2 item in BACKLOG.md after the concurrent shelter-piece task completes.

### 2026-09-10 15:28 EEST - Add workbench and persisted private storage interaction

Outcome: Completed the next required-camp-piece increment. Paid workbenches now assemble floor/wall/roof kits with the existing costs, and paid woven chests support inspect/store-one/take-one controls in Camp crafting. The server chooses and validates the reachable visible chest, persists bounded contents under the stable construction and immutable world identities, then commits the private pack exchange. Original procedural bench/chest silhouettes derive from the accepted replicated kit. Construction save references are now retained through garbage collection alongside the new storage container.

Changed: `Source/KalmalaGameplay/Public/KalmalaConstructionActor.h`; `Source/KalmalaGameplay/Private/KalmalaConstructionActor.cpp`; `Source/KalmalaGameplay/Public/KalmalaCraftingComponent.h`; `Source/KalmalaGameplay/Private/KalmalaCraftingComponent.cpp`; `Source/KalmalaGameplay/Public/KalmalaGameMode.h`; `Source/KalmalaGameplay/Private/KalmalaGameMode.cpp`; `Source/KalmalaGameplay/Public/KalmalaInventoryComponent.h`; `Source/KalmalaGameplay/Private/KalmalaInventoryTransactions.cpp`; new `Source/KalmalaGameplay/Public/KalmalaStorageSaveGame.h`; new `Source/KalmalaGameplay/Private/KalmalaStorageSaveGame.cpp`; new `Source/KalmalaGameplay/Private/KalmalaStorageInteraction.cpp`; new `Source/KalmalaGameplay/Private/KalmalaStorageVerification.cpp`; new `Source/KalmalaGameplay/Private/Tests/KalmalaStorageTest.cpp`; `Source/KalmalaUI/Public/KalmalaCraftingSubsystem.h`; `Source/KalmalaUI/Private/KalmalaCraftingSubsystem.cpp`; new `Scripts/Verify-Storage.ps1`; `docs/02-technical-architecture.md`; `docs/07-development-setup.md`; `docs/10-campfire-and-crafting.md`; `BACKLOG.md`; `PROGRESS.md`. Working tree was clean at start; handoff updated directly in the main checkout.

Verification: Final forced `KalmalaEditor Win64 Development -WaitMutex -NoHotReload -Force -MaxParallelActions=4` passed with LOCALAPPDATA UnrealBuildTool cache access. All ten focused Storage, Crafting, Construction, and Inventory tests passed, exit 0 (`C:/Users/Ville/AppData/Local/Temp/KalmalaStorageFinal-9b8ed9f64cd24dae8eb9726e7353ce05/automation.log`). `Scripts/Verify-Storage.ps1 -Port 17971` passed both fresh and restarted host/client runs (`C:/Users/Ville/AppData/Local/Temp/KalmalaStorage-d9e2bf7db01f4c3f99f9d75cce9fe678`): ordinary paid placement, bench assembly without a hearth, distance/obstruction/unknown-item rejection, simulated failed-write conservation, real owning RPC deposit/withdraw, owner-only snapshots and explicit clearing, exactly three persisted wood per chest plus one private carried wood, and the same two stable chest IDs after restart. Earlier fixture failures were repaired: initialize Unreal replication metadata before inspecting it; choose distinct nearest-chest positions on restart; parse the listen port with an explicit regex match object. PowerShell parse and `git diff --check` passed.

Multiplayer impact: Shared actors replicate kit/placement identity only. Storage inspect and close RPCs carry no target; transfer RPCs carry only a validated item ID and always move one unit. Authority, controller, world, registered construction record, range, visibility, source count, destination capacity, save write, and final inventory mutation remain server-owned. Contents and open state replicate only to the inspecting pawn owner, refresh or expire every 0.25 seconds, and clear on closing. New schema-1 storage slots are bounded to 128 chest records and 16 unique catalogue-limited stacks each; invalid existing slots fail closed without overwrite. Existing construction, player, population, terrain, weather, and world-generation save schemas are unchanged.
...
Outcome: Completed the explicit user-requested integrated generation rework. New revision-7 worlds crop and rotate a separately seeded Perlin land/water atlas at the existing 16 km radius. Existing regional/climate signals place the four special land biomes subject to hard origin-distance limits; Meadows/Mountains fill remaining land, and only Meadows/Ocean occur through 350 m. Meadows stops at 4 km. Central dry starts, coast-constrained terrain, retained rivers, and separate revision-8 debug streams share the same immutable server identity. Revisions 1–6 retain their layouts; no saved-data schema changed.

Changed: new Source/KalmalaWorld/Public/KalmalaMasterMap.h and Private/KalmalaMasterMap.cpp; WorldFieldSampler, WorldGenerationConfig, RegionalGeneration header/implementation, RegionalTuning, WorldPlayerStartResolver, WorldGenerationGameState verification footprint; new Private/Tests/KalmalaMasterMapTest.cpp; RenderWorldGenerationVisualizationCommandlet.cpp; Scripts/Verify-Minimap.ps1; docs/01-game-design.md, 02-technical-architecture.md, 04-roadmap.md, 05-decision-log.md, 07-development-setup.md, 08-world-generation-and-biomes.md and master-map-preview.png; run-owned BACKLOG.md contract/note and this PROGRESS.md handoff. Main checkout updated directly. Pre-existing BACKLOG/PROGRESS notes, Scripts/Verify-PersistedCampHearth.ps1 and docs/10-campfire-and-crafting.md changes are preserved and excluded from staging.

Verification: Final forced KalmalaEditor Win64 Development -WaitMutex -NoHotReload -Force -MaxParallelActions=4 build passed. MasterMap, FiniteWorld, Regional.Integrated, Water.ClippedSurface, Water.OceanDepth and Minimap.GenerationPerformance all reported Success (automation.log); the expanded exact-boundary/default-launch-start test also passed (default-start.log). Evidence directory: C:/Users/Ville/AppData/Local/Temp/KalmalaMasterMap-b95915d5c56c4c2a8dac39d47c0e536c. All repeated seed-418 PPM hashes match; seed 419 changes crop, biomes and shaped height. The retained preview was visually inspected. Final Scripts/Verify-Minimap.ps1 -GeneratorRevision 7 -Port 18071 passed with host/client fingerprint 11394198200627428669 across 81 positions in a 20 km square; logs: C:/Users/Ville/AppData/Local/Temp/KalmalaMinimap-2dab1bab4e9843999d05bbbcbadccfe2. Whitespace and PowerShell parse checks passed. Initial build found a shadowed local name and was repaired; initial preview exit 1 came from restricted installed DDC and passed with the documented temporary no-Zen cache.

Multiplayer impact: Server still chooses and replicates only WorldSeed/GeneratorRevision. Master seed and tuning are revisioned constants; crop transforms are pure derived values memoized per worker. Clients consume that identity for presentation/prediction and cannot choose terrain, biome, radius, population, placement or outcomes. Existing validated authority, sparse saves, RPCs and schema are unchanged. Development fingerprint sampling now includes outer biome distances.

Known limits: The master seed is a code-level revisioned constant, not a per-world UI setting. Existing regional scales and analytic basin/hydrology limitations remain. The 32 km preview can undersample small lakes/channels; no full-world human traversal, rendered peer UI run or dedicated-server proof is claimed. The crop's bounded candidate search favours inland origins; tests cover seeds 418, 419 and the normal launch seed. M2 persisted-camp acceptance remains unrelated and unresolved.

Next task: Resume the existing first unchecked M2 shared persisted-camp item: diagnose the joining-client stall and verify construction/storage/shelter/weather agreement before restart acceptance. Use revision 7 for new-world manual inspection, or explicitly retain older seed/revision pairs for existing worlds.


### 2026-09-12 09:45 EEST - Add fast PNG world-map tuning workflow

Outcome: Completed the user-directed developer export increment. Scripts/Export-WorldMaps.ps1 writes MasterLandWater.png, LandWaterCrop.png and Biomes.png into ignored .cache/WorldMaps, with effective tuning/transform/timings in LastRender.txt. -Watch keeps a headless commandlet warm and reloads Scripts/WorldMapPreview.params after stable edits. Parameters include independent master/game seeds, atlas wavelength, land threshold, regional scale/warp and origin-distance eligibility. -Build is optional after C++ edits. No gameplay map is loaded.

Changed: new Scripts/Export-WorldMaps.ps1, Scripts/WorldMapPreview.params, Scripts/Verify-WorldMapExport.ps1; new Source/KalmalaEditor/Public/ExportWorldMapsCommandlet.h and Private/ExportWorldMapsCommandlet.cpp; new Source/KalmalaWorld/Public/KalmalaGenerationPreview.h and Private/KalmalaGenerationPreview.cpp; KalmalaMasterMap header/implementation, KalmalaRegionalGeneration header/implementation and KalmalaMasterMapTest.cpp; README.md, docs/02-technical-architecture.md, docs/07-development-setup.md, docs/08-world-generation-and-biomes.md; only this run's appended BACKLOG/PROGRESS handoff. Preserved pre-existing persisted-camp changes in BACKLOG.md, PROGRESS.md, Scripts/Verify-PersistedCampHearth.ps1 and docs/10-campfire-and-crafting.md; exclude them from staging. Main checkout updated directly.

Verification: Final forced KalmalaEditor Win64 Development -WaitMutex -NoHotReload -Force -MaxParallelActions=4 passed. Kalmala.World.Regional (FiniteWorld, Integrated, MasterMap) and Kalmala.UI.Minimap.GenerationPerformance all passed in C:/Users/Ville/AppData/Local/Temp/KalmalaMapExportRegression-7801fd71a46944b4ae3d8b6d18db7c29/final.log, including fast/full seeded biome agreement and refusal to install overrides in interactive editor/game. Final Scripts/Verify-WorldMapExport.ps1 passed in C:/Users/Ville/AppData/Local/Temp/KalmalaMapExportProof-884fc88cb58b4b9aa5458bb25c7448ad: every visible 64x64 fast/full biome pixel agrees for default and overridden parameters, PNG signatures pass, invalid input retains output, parameter changes vary all images, restored defaults reproduce hashes. One-shot default 512x512 PNGs were created and visually inspected: 0.326 s sampling / 0.350 s export (30.27 s including first headless startup while other checks ran). Final Verify-Minimap -GeneratorRevision 7 passes in C:/Users/Ville/AppData/Local/Temp/KalmalaMinimap-537ccbaa4345429aa5e37142c0bf1a8c with unchanged fingerprint 11394198200627428669 across 81 positions. PowerShell parsing and git whitespace checks passed. Initial build caught the file-manager Move return type and was repaired before verification.

Multiplayer impact: No identity, production tuning, replication, authority, RPC or save-schema change. Preview settings can be installed only in an editor commandlet, are thread-local, reset after each export, and invalidate derived caches. Gameplay always retains compiled defaults; host/client fingerprints remain unchanged. The fast biome path shares production logic and skips only hydrology/height work that cannot affect revision-7/8 labels. The output is diagnostic data, never a world save or trusted client input.
