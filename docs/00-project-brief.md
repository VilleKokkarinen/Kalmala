# Kalmala project brief

## One-line pitch

Up to four wanderers build a sanctuary in a mythic northern wilderness, learn ancient protective arts, and brave the wilds for the materials needed to endure.
...
- **Camera:** Close third person; evaluate an optional first-person mode after the vertical slice.
- **Business model:** To be decided. If monetisation is added, it may include cosmetic items and cosmetic loot boxes only; it must never create pay-to-win advantages.
...
The project may learn from high-level principles of systemic simulation, survival progression, and co-op building. It must not reproduce specific content, UI, terminology, characters, stories, assets, maps, enemy designs, or code from any reference work.
