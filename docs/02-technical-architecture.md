...
| Gameplay population layout | server | derive invisible spatial keys, per-kind deterministic seeds, and bounded wildlife/harvest/hazard budgets from immutable world identity and continuous fields; clients never select gameplay placements |
